...
<head>
  ...
  <!-- CSS Libraries -->
  <link rel="stylesheet" href="../dashboard/node_modules/bootstrap-social/bootstrap-social.css">
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../dashboard/assets/img/stisla-fill.svg" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('login.data') }}" class="needs-validation">
                  @csrf
                  ...
                  <a href="{{ url('/') }}" class="btn btn-warning btn-lg btn-block">Kembali</a>
                  </div>
                </form>
